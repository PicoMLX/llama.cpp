...
# Pico AI Server Web UI

Welcome to the **Pico AI Server Web UI** component library! This Storybook showcases the components used in the modern web interface for the llama.cpp server.

## 🚀 About This Project

WebUI is a modern web interface for the Pico AI Server server, built with SvelteKit and ShadCN UI. Features include:
